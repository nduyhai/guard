 ...
 *
 * <ol>
 *   <li>Timestamps older than the window start are discarded.
 *   <li>If the count is below the limit, a new timestamp is recorded and the call is allowed.
 *   <li>Otherwise the call is denied with a {@code retryAfter} hint.
 * </ol>
 *
 * <p>A per-key {@link ReentrantLock} serialises access to each deque, making the implementation
 * virtual-thread friendly (no {@code synchronized} on shared monitors).
 */
