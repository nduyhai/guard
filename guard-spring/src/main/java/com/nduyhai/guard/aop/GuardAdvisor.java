...
/**
 * Spring AOP {@link PointcutAdvisor} that applies {@link GuardMethodInterceptor} to
 * any method or class annotated with a Guard annotation.
 *
 * <p>The pointcut is the union of four {@link AnnotationMatchingPointcut}s (one per annotation),
 * each checking both method and class level. Order is {@code Ordered.LOWEST_PRECEDENCE - 100}
 * so Guard runs after transaction management but before most application advisors.
 */
